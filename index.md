...
### Biography
I'm a fifth-year Ph.D. student ([MyCV](/MyCV260420.pdf)) in the School of Computer Science, [Nanjing University (NJU)](https://www.nju.edu.cn/en), supervised by Professors [Guihai Chen](http://cs.nju.edu.cn/gchen) ([IEEE Fellow](https://services27.ieee.org/fellowsdirectory/keywordsearch.html?keyword=Chen%20Guihai) & [CCF Fellow](https://www.ccf.org.cn/Membership/Individual_member/Honor/2021-07-21/671453.shtml)) and [Haipeng Dai](https://cs.nju.edu.cn/daihp/) ([IET Fellow](https://www.theiet.org/membership/member-news/online-updates/online-updates-2025/recently-elected-fellows-july-to-october-2025)). From Sep. 2025 to Jan. 2026, I conducted a short-term academic visit at the School of Software, [Tsinghua University (THU)](https://www.tsinghua.edu.cn/en/), under the supervision of Associate Professor [Shaoxu Song](https://sxsong.github.io/). Since Aug. 2026, I have been a visiting Ph.D. student at the School of Computing, [National University of Singapore (NUS)](https://www.nus.edu.sg/), supervised by Professor [Xiaokui Xiao](https://www.comp.nus.edu.sg/~xiaoxk/) ([IEEE Fellow](https://services27.ieee.org/fellowsdirectory/keywordsearch.html?keyword=Xiao%20Xiaokui)), with the visit scheduled to continue until Aug. 2027.
...
2. **Data Analysis and Processing with LLMs** [[Survey of Multi-Agent Cooperation]](https://xue-guang.com/post/llm-marl/) [[Tutorials of Data Agent]](https://2026.sigmod.org/slides/DataAgents-SIGMOD2026.pdf)
...
Some ostensibly clever individuals already exploit LLMs to churn out papers by the dozen, padding their publication records. **Yet they are chasing numbers, not advancing the field.** Under the current academic evaluation system, however, such gaming of metrics is precisely what gets rewarded: they produce academic rubbish while monopolizing resources beyond the reach of ordinary researchers. What an absurdity. Those who genuinely hold academic ideals are the ones laboring in obscurity, probing problems until they grasp their essence—yet these are often the very people whose publication records look unremarkable. What a tragedy.
...
[ICDE'26] **Shizhe Liu**, Haipeng Dai, Meng Li, Yuemeng Zhang, Shaoxu Song, Zhifeng Bao, Hancheng Wang, Xiaofeng Gao, Guihai Chen. When Complex Event Recognition Meets Cloud-Native Architectures. In ICDE, May 4-8, Montreal, Canada, 2026. **CCF-A**. [📄](https://ieeexplore.ieee.org/abstract/document/11629366) [🎞](cloud_cer_2.pptx) [🖥️](https://github.com/Josehokec/CERMeetsDS)
...
2. Reviewer: [AAAI 2027](https://aaai.org/conference/aaai/aaai-27/), [ICDM 2026](https://icdm2026.neu.edu.cn/), [IoTJ 2026](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=6488907), [TCE 2026](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=30), [WAIC Academic 2026](https://waica2026.worldaic.com.cn/).
...
📧: **shizheliu@smail.nju.edu.cn** (NJU email) or **t0939974@u.nus.edu** (NUS email)
